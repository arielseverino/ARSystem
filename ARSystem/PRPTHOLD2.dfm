  ...
  object SIForm: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object qreDeliverQty: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'formatnumeric('#39'#,##0'#39',deliverqty) '
        FontSize = 12
      end
    ...
    object PageFooterBand1: TQRBand
      ...
      object qreTotGross1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'formatnumeric('#39'#,##0.000'#39',sum(grossamt) )'
        FontSize = 12
      end
      ...
      object qreZeroRated: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'IF(TaxAmt=0,formatnumeric('#39'#,##0.000'#39',sum(grossamt) ),'#39#39')'
        FontSize = 12
      end
      ...
      object qreVatAmt: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'IF(TaxAmt>0,formatnumeric('#39'#,##0.000'#39',sum(TaxAmt) ),'#39#39')'
        FontSize = 12
      end
      object qreTotsales: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'formatnumeric('#39'#,##0.000'#39',sum(Grossamt+TaxAmt) )'
        FontSize = 12
      end
      object qreLessVat: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'formatnumeric('#39'#,##0.000'#39',sum(TaxAmt) )'
        FontSize = 12
      end
      object qreZeroRatedSales: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'IF(TaxAmt=0,'#39'ZERO-RATED SALES'#39','#39#39')'
        FontSize = 20
      end
